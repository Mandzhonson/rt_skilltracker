...
Демонстрационные материалы, показывающие работу системы, находятся в папке:

```
demo/
```

В ней представлены видеозаписи с демонстрацией основных возможностей приложения.
