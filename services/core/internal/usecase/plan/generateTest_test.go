...
type mockAIClientForTest struct{}

func (m *mockAIClientForTest) Generate(ctx context.Context, prompt string) (string, error) {
	return `{
		"questions": [
...
func TestPlanService_generateTestForPlan(t *testing.T) {
	...
	mockClient := &mockAIClientForTest{}
