...
export const CreatePlan = () => {
    ...
    try {
      ...
      if (response.data) {
        if (Array.isArray(response.data)) {
          ...
          // Если ничего не подошло, пробуем найти массив в ответе
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await managerAPI.createPlan({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="card">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">Создать план развития</h1>
